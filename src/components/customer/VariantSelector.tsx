...
interface VariantSelectorProps {
  ...
  onAdd: (variant: Variant & { groupName?: string }) => void;
}
 ...
 */
export default function VariantSelector({ item, currencySymbol, onAdd }: VariantSelectorProps) {
  ...
  const groupName = (allVariants[0] as Variant & { groupName?: string })?.groupName ?? "Options";
