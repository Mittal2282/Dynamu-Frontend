...
function IconAI({ className, style }: IconProps) {
  return (
    <svg
      className={className}
      style={style}
...
function IconOrders({ className, style }: IconProps) {
  return (
    <svg className={className} style={style} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export default function BottomNavigator({ basePath: basePathProp, aiChatOpen = false, onChatClick, onNavigate }: BottomNavigatorProps) {
  ...
  const innerClass = (_active?: boolean) =>
    [
