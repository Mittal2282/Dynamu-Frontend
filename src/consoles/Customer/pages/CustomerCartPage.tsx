...
import { cartStore, useCartCount, useCartItems } from "../../../store/cartStore";
...
function BillRow({ label, value, bold, accent }: BillRowProps) {
  return (
...
export default function CustomerCartPage() {
  ...
  const { basePath, onPlaceOrder, orderingCart } = useOutletContext<CustomerOutletContext>();
  const items = useCartItems() as CartItemData[];
  ...
  const subtotal = items.reduce((s, i) => {
    ...
    const p =
      i.discount_percentage != null && i.discount_percentage > 0
    ...
    >
      <div className="max-w-5xl mx-auto px-4 md:px-6 lg:px-8 pt-6">
        ...
        <div className="flex items-baseline gap-3 mb-6">
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-black text-white">Your Cart</h1>
          {count > 0 && (
            <span
            ...
            <div className="lg:sticky lg:top-24">
              ...
              >
                ...
                <div className="border-t" style={{ borderColor: "var(--t-line)" }}>
                  <BillRow label="Subtotal" value={formatCurrency(subtotal, currencySymbol, 2)} />
                  <BillRow
                ...
                <p className="text-center text-xs mt-3" style={{ color: "var(--t-dim)" }}>
