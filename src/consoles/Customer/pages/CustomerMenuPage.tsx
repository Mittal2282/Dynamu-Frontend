...
function CategorySection({ name, items, currencySymbol, innerRef }: CategorySectionProps) {
  return (
...
function VegToggle({ vegFilter, onChange }: VegToggleProps) {
  return (
    <div
...
export default function CustomerMenuPage() {
  ...
  const allMenuItems = useMemo<MenuItem[]>(() => Object.values(menu).flat(), [menu]);
