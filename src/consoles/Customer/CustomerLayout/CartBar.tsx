...
export default function CartBar({ count, onViewCart }: CartBarProps) {
  ...
  return (
    <div className="md:hidden fixed bottom-23.75 left-0 right-0 z-30 flex justify-center px-4">
      <div className="w-full bg-brand rounded-2xl px-5 py-4 flex items-center justify-between shadow-2xl">
        <div>
