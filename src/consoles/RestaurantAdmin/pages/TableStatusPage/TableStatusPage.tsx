...
import { getDashTables, freeTable, addTablesToFloor, toggleTableActive } from '../../../../services/dashboardService';
...
export default function TableStatusPage() {
  ...
  const STATUS_SORT_ORDER: Record<string, number> = { billing: 0, occupied: 1, free: 2, unserviceable: 3 };
