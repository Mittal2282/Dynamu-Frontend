 ...
 */
export function getTheme(themeNumber: number | string): Theme {
...
export function buildCssTokens(
  themeNumber: number | string = DEFAULT_THEME_NUMBER,
 ...
 */
export function applyCssTokens(tokens: Record<string, string>): void {
