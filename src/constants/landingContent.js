export const CHAT_MESSAGES = [
  ...
  { from: 'bot', text: "Done. That's Rs. 595 total. You've unlocked Happy-Hour 20% off on drinks.", delay: 3.6 },
];
...
export const SOLUTION_BULLETS = [
  ...
  {
    label: 'Hindi and Hinglish native',
...
export const CAPABILITY_ITEMS = [
  {
    letter: 'A',
    label: 'AI Chat Menu',
    desc: 'Natural-language ordering across English, Hindi, and Hinglish — meeting guests where they communicate.',
    colorKey: 'orange',
  },
  {
    letter: 'U',
    label: 'Smart Upselling',
    desc: 'Combo and cross-sell recommendation engine consistently driving 20–40% average order value uplift.',
    colorKey: 'cyan',
  },
  {
    letter: 'D',
