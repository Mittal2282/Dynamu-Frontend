...
export type CustomerPhase = 'waiting' | 'preparing' | 'completed';
...
export const ORDER_STATUSES: OrderStatus[] = ['pending', 'confirmed', 'preparing', 'ready', 'served'];
...
export function getCustomerPhase(status: string): CustomerPhase {
...
export const CUSTOMER_STATUS_PHASE: Record<string, string> = {
