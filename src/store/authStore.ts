...
interface AuthState {
  ...
  setGuestName: (guestName: string | null) => void;

  // Admin tokens
  adminAccessToken: string | null;
  setAdminAccessToken: (adminAccessToken: string | null) => void;
  adminRefreshToken: string | null;
  setAdminRefreshToken: (adminRefreshToken: string | null) => void;
  adminRole: string | null;
  setAdminRole: (adminRole: string | null) => void;
  adminName: string | null;
  setAdminName: (adminName: string | null) => void;
